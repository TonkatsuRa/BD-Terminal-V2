(function () {
    ...
    // Per-site operator hint printed at the bottom of /WELCOME.
    // Each entry is an array of [text, className] tuples appended after the
    // default record list. Used to seed the puzzle chain — BRE-06 receives
    // the player on first connect and nudges them toward the first internal DB.
